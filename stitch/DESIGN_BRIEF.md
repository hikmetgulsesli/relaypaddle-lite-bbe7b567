...
- RelayPaddle Lite turns the user's request into a directly usable game workflow. The first experience must be the actual browser game behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser-game called RelayPaddle Lite. It should be a full-viewport arcade timing game where the player keeps a signal orb moving between two paddles, with live score, combo multiplier, pause/restart, settings overlay, keyboard and click controls, and visible recovery states. Avoid landing pag…
...
- Gameplay - RelayPaddle Lite
- Game Settings - RelayPaddle Lite

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Gameplay - RelayPaddle Lite
...
SCREEN_SPEC_2:
- exact_screen_title: Game Settings - RelayPaddle Lite
